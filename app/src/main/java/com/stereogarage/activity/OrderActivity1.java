...
public class OrderActivity1 extends AppCompatActivity  implements View.OnClickListener,NetUtil.My_callback,AllInterface.Cb{
...
//            responseData = null;
    ...
    public void callback3(final String param) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                PI = NetUtil.parse_parkinginfo2(param);
                ...
                if (PI.status==1) {
                    ...
                    String money = PI.money;
                    Intent intent1 = new Intent(OrderActivity1.this, PayDemoActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.finish_parking:
                try {
//                  responseData = null;
                    post_containsurl(Const_Util.Map_Url14, value,this);
                } catch (IOException e) {
                    e.printStackTrace();
                }
