 ...
 */
public class weixinMainActivity extends Activity implements OnClickListener {
	private static final String TAG = "weixinMainActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.weixinactivity_main);
	...
	private void genPayReq() {
		...
		if (resultunifiedorder!=null) {
			...
			Toast.makeText(weixinMainActivity.this, "prepayid为空", Toast.LENGTH_SHORT).show();
		}
	...
	private class PrePayIdAsyncTask extends AsyncTask<String,Void, Map<String, String>> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			dialog = ProgressDialog.show(weixinMainActivity.this, "提示", "正在提交订单");
		}
		...
		protected Map<String, String> doInBackground(String... params) {
			...
			return xml;
			//return (String) xml.get("prepay_id");
		}
	}
	...
	private String getProductArgs() {
		...
		try {
			...
			packageParams.add(new BasicNameValuePair("nonce_str", nonceStr));//nonceStr  "aa486f25175cbdc3854151288a645c19"
			packageParams.add(new BasicNameValuePair("notify_url", "https://api.mch.weixin.qq.com"));//写你们的回调地址
			packageParams.add(new BasicNameValuePair("out_trade_no",genOutTradNo()));//genOutTradNo()  "39dd987a9d27f1045aa0ad3ed5995dd2"
			packageParams.add(new BasicNameValuePair("sign_type","MD5"));
			packageParams.add(new BasicNameValuePair("total_fee", "1"));
			packageParams.add(new BasicNameValuePair("trade_type", "APP"));
			String sign=getPackageSign(packageParams);
			packageParams.add(new BasicNameValuePair("sign", sign)); //sign "74EA40F6FED1B34427895D933AA03AB3"
