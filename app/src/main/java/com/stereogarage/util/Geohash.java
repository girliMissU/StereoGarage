...
/**
 * Created by niudan on 2019/11/15.
 */
...
public class Geohash {
     ...
     * 纬度binary长度
     */
    private static int LAT_LENGTH = 12;

    /**
     * 经度binary长度
     */
    private static int LNG_LENGTH = 13;
    ...
    public static void main(String[] args){
        ...
        System.out.println(getLocationBase32String(39.928167, 116.389550));


        System.out.println(getLocationBase32StringAround(39.928167, 116.389550));
